    ...
    <CartModalContainer>
      ...
      >
        <CartModalHeader tabIndex={0}>
          ...
          <CartModalCloseButton aria-label={`Modal Close`} onClick={onClose}>
            X
          </CartModalCloseButton>
        </CartModalHeader>
        <CartModalBody>
        ...
        <CartModalFooter>
          ...
          <CheckoutButton
            ...
            centerChild={cartList.length > 0 ? true : false}
          >
            <span>
              {cartList.length > 0 ? "Proceed to Checkout" : "Start Shopping"}
            </span>
            {cartList.length > 0 && (
